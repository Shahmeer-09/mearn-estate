...
const Listing = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if(formdata.imageUrls.length < 1) return setlistingError("Upload atleast one image")
      if(formdata.regularPrice < formdata.discountPrice) return setlistingError("regular price must be greater than discount")
      setlistLoading(true);
    ...
    <main className=" max-w-4xl  mx-auto p-10 ">
      ...
      >
        ...
        <div className="  flex flex-col gap-4 ">
          ...
          >
            {listLoading === true ? "Creating...." : "Create List"}
          </button>
